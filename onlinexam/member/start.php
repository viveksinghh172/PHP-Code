...
<html>
    ...
    <body>
        ...
        <div id="content" style="margin-left: 250px;">
            ...
            <div class="w3-display-topleft w3-container w3-white" style="margin: 10px;"><strong  style="color: #2196F3;font-size: 18px;font-family: Myriad Pro,serif;">Welcome <?php echo $_SESSION['name']; ?></strong></div>
            ...
            <div class="w3-display-bottomleft w3-container w3-white" style="margin: 10px;"><strong  style="color: #2196F3;font-size: 18px;font-family: Myriad Pro,serif;">Subject Name :<?php echo $subject; ?></strong></div>
