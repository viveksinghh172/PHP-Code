					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="#"><i class="fa fa-cogs" aria-hidden="true"></i> Add Categoery <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="add_categoery.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Add Cate</a></li>
										<li class="mini_list_w3"><a href="grids.html"> <i class="fa fa-caret-right" aria-hidden="true"></i> Grids</a></li>
									</ul>
								</li>
								<li>
									<a href="#"><i class="fa fa-cogs" aria-hidden="true"></i> Add Questions <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="add_questions.php"><i class="fa fa-caret-right" aria-hidden="true"></i> add Questions</a></li>
										<li class="mini_list_w3"><a href="grids.html"> <i class="fa fa-caret-right" aria-hidden="true"></i> Grids</a></li>
									</ul>
								</li>
								<li>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="../upload_pic/<?php echo $user_key;?>.png" style="border-radius: 50%; width:45px; height: 45px; " > </span> 
											</div>	
										</a>
