...
INSERT INTO `add_questions` (`q_id`, `cate_id`, `Ques`, `ans1`, `ans2`, `ans3`, `ans4`, `right_ans`) VALUES
(2, 2, 'What is full form of html ?', 'Hyper text markup language', 'Hyper text meanlanguage', 'Hyper text pro language', 'Hyper text matchlanguage', 'Hyper text markup language'),
(3, 2, 'What is full form of html Now ?', 'Hyper text markup language', 'Hyper text meanlanguage', 'Hyper text pro language', 'Hyper text matchlanguage', 'Hyper text markup language'),
(4, 1, 'What is full form of php ?', 'Personal home page', 'Hyper text meanlanguage', 'Hyper text pro language', 'Hyper text matchlanguage', 'Personal home page'),
(5, 3, 'What is full form of css?', 'Personal home page', 'Hyper text meanlanguage', 'Hyper text pro language', 'Hyper text matchlanguage', 'Personal home page');
