  ...
  $(document).ready(function()
	{
		...
		$(".add-cart").click(function()
		{
			//alert("Hii")
			 ...
			 $.post('admin_panel/api.php',{'addcart':1,'pid':pid,'quan':1},function(res)
			 {
				 alert(res);
			 })
		})
		...
		<div class="container">
			<div class="w3ls_mobiles_grids">
				...
				<div class="col-md-8 w3ls_mobiles_grid_right">
					...
					<?php
					$sel=mysqli_query($con,"select * from product where category='$cat'");
                      ...
                      <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<div class="simpleCart_shelfItem">
									<p> <i class="item_price">Rs.<?= $arr['price'];?></i></p>
									<form action="#" method="post">
										<input type="hidden" id="pid" value="<?= $arr['id'];?>" />
									   
										<button type="button" class="add-cart" pid="<?= $arr['id'];?>">Add to cart</button>
									</form>
								</div> 
