    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="/" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column">
                <span class="font-weight-bold mb-2"><?= ucwords($suname);?></span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="?con=category">
              <span class="menu-title">Category</span>
              <i class="mdi mdi-home menu-icon"></i>
            </a>
          </li>
          <li class="nav-item">
          <a class="nav-link" href="?con=products">
        ...
        if(!$_GET['con'])
        {
          ...
          switch($_GET['con'])
          {
              ...
              case 'addcat': include("addcategory.php");
                               break;
              case 'editcat': include("editcategory.php");
                               break;
              case 'prodcat': include("productcategory.php");
                               break;
          }
